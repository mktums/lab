...
| 5b | Critical | [Kopia agents (lab services, PC, MacBook, Android)](005b-kopia-agents.md) | Hard | In progress |
| 5c | Normal | [Service backups: step-ca, postgres, vaultwarden, linkwarden](005c-kopia-service-backups.md) | Medium | In progress |
